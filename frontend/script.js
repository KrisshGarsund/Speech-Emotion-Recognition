...
function downloadAsPDF() {
    ...
    doc.text('AuraVoice', 105, 20, { align: 'center' });
    doc.setFontSize(12);
    ...
    doc.text('Generated by AuraVoice - Speech Emotion Recognition System', 105, 285, { align: 'center' });
...
function downloadAsImage() {
    ...
    card.innerHTML = `
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #c4f82a; font-size: 36px; margin: 0 0 10px 0;">AuraVoice</h1>
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('AuraVoice initialized');
